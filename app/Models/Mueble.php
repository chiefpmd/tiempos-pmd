...
class Mueble extends Model
{
    ...
    protected $fillable = ['proyecto_id', 'numero', 'descripcion', 'costo_mueble', 'presupuesto_nomina', 'jornales_presupuesto', 'avance_porcentaje', 'fecha_entrega'];

    protected $casts = [
        'costo_mueble' => 'decimal:2',
        'presupuesto_nomina' => 'decimal:2',
        'jornales_presupuesto' => 'decimal:1',
        'avance_porcentaje' => 'decimal:1',
        'fecha_entrega' => 'date',
    ];
